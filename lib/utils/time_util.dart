...
class TimeUtil {
  ...
  /// get DateTime By DateStr.
  static String getDateTimeToLocalFormat(String dateStr, DateFormat mDateFormat,
    ...
    return TimeUtil.formatDateTime(
        time ?? '', mDateFormat, dateSeparate, timeSeparate);
  }
  ...
  static bool isYesterday(DateTime dateTime, DateTime locDateTime) {
    if (yearIsEqual(dateTime, locDateTime)) {
      int spDay =
          TimeUtil.getDayOfYear(locDateTime) - TimeUtil.getDayOfYear(dateTime);
      return spDay == 1;
    } else {
